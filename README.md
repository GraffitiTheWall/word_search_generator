A python generator that uses backtracking and reportlab to output word_search pdfs. When the main.py file is run, use the command line to enter any words that you want in your wordsearch.
